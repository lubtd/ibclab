...
import (
	...
	appparams "github.com/lubtd/ibclab/app/params"
...
func New(
	...
	app.IbclabKeeper = *ibclabkeeper.NewKeeper(
		appCodec,
		keys[ibclabtypes.StoreKey],
		keys[ibclabtypes.MemStoreKey],
	)
	ibclabModule := ibclab.NewAppModule(appCodec, app.IbclabKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		evidencetypes.ModuleName, stakingtypes.ModuleName, ibchost.ModuleName, testnettypes.ModuleName,
	)

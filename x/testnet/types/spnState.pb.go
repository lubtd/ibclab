...
func (m *SpnState) GetClientID() string {
	if m != nil {
		return m.ClientID
	}
	return ""
...
var fileDescriptor_a2656e0317cbd343 = []byte{
	...
	0x95, 0xc2, 0xb8, 0x38, 0x82, 0xa1, 0xba, 0x85, 0x24, 0xb8, 0xd8, 0x93, 0x8b, 0x52, 0x13, 0x4b,
	0xf2, 0x8b, 0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x21, 0x11, 0x2e, 0xd6, 0xcc,
	0xbc, 0x94, 0xd4, 0x0a, 0x09, 0x26, 0xb0, 0x38, 0x84, 0x23, 0x24, 0xc5, 0xc5, 0x91, 0x9c, 0x93,
	0x99, 0x9a, 0x57, 0xe2, 0xe9, 0x22, 0xc1, 0x0c, 0x96, 0x80, 0xf3, 0x9d, 0x1c, 0x4f, 0x3c, 0x92,
	...
	0x39, 0x3f, 0x57, 0x1f, 0xec, 0x50, 0x7d, 0x88, 0x43, 0xf5, 0x2b, 0xf4, 0x61, 0xfe, 0x29, 0xa9,
	0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xbb, 0xd0, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x24, 0xf9,
	0xbc, 0x65, 0xe7, 0x00, 0x00, 0x00,
}
...
func (m *SpnState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClientID) > 0 {
		...
		i = encodeVarintSpnState(dAtA, i, uint64(len(m.ClientID)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Index) > 0 {

...
import LubtdIbclabLubtdIbclabSpn from './lubtd/ibclab/lubtd.ibclab.spn'
import CosmosCosmosSdkCosmosCrisisV1Beta1 from './cosmos/cosmos-sdk/cosmos.crisis.v1beta1'
import LubtdIbclabLubtdIbclabTestnet from './lubtd/ibclab/lubtd.ibclab.testnet'
...
export default { 
  ...
  LubtdIbclabLubtdIbclabSpn: load(LubtdIbclabLubtdIbclabSpn, 'lubtd.ibclab.spn'),
  CosmosCosmosSdkCosmosCrisisV1Beta1: load(CosmosCosmosSdkCosmosCrisisV1Beta1, 'cosmos.crisis.v1beta1'),
  LubtdIbclabLubtdIbclabTestnet: load(LubtdIbclabLubtdIbclabTestnet, 'lubtd.ibclab.testnet'),

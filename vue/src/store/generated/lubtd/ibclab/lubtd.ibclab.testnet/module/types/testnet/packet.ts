...
export interface TestnetPacketData {
...
const baseTestnetPacketData: object = {}

export const TestnetPacketData = {
  encode(message: TestnetPacketData, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): TestnetPacketData {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseTestnetPacketData } as TestnetPacketData
  ...
  fromJSON(object: any): TestnetPacketData {
    const message = { ...baseTestnetPacketData } as TestnetPacketData
  ...
  toJSON(message: TestnetPacketData): unknown {
    const obj: any = {}
    message.noData !== undefined &&
  ...
  fromPartial(object: DeepPartial<TestnetPacketData>): TestnetPacketData {
    const message = { ...baseTestnetPacketData } as TestnetPacketData
    if (object.noData !== undefined && object.noData !== null) {
